...
public class EventTooltip {
    ...
    private static void renderFilterStack(PoseStack matrices, ItemRenderer itemRenderer, ItemStack itemStack, int x, int y) {
        ...
        MTLasersItemRenderer tooltipItemRenderer = new MTLasersItemRenderer(mc.getTextureManager(), mc.getModelManager(), mc.getItemColors(), blockentitywithoutlevelrenderer);
