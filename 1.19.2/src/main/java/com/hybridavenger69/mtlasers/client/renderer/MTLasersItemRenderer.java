...
public class MTLasersItemRenderer extends ItemRenderer {
    public MTLasersItemRenderer(TextureManager textureManager, ModelManager modelManager, ItemColors itemColors, BlockEntityWithoutLevelRenderer blockEntityWithoutLevelRenderer) {
