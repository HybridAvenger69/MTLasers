...
public class FilterCountScreen extends AbstractContainerScreen<FilterCountContainer> {
    private final ResourceLocation GUI = new ResourceLocation(MTLasers.MODID, "textures/gui/filtercount.png");
    ...
    protected void renderLabels(PoseStack stack, int mouseX, int mouseY) {
        ...
        //font.draw(stack, Component.translatable("screen.mtlasers.comparenbt").getString(), 5, 25, Color.DARK_GRAY.getRGB());
