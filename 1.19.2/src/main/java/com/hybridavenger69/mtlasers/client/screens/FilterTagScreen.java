...
import com.hybridavenger69.mtlasers.client.screens.widgets.IconButton;
...
import com.hybridavenger69.mtlasers.common.network.packets.PacketUpdateFilterTag;
import com.hybridavenger69.mtlasers.util.MagicHelpers;
...
public class FilterTagScreen extends AbstractContainerScreen<FilterTagContainer> {
    private final ResourceLocation GUI = new ResourceLocation(MTLasers.MODID, "textures/gui/filtertag.png");
    ...
    int cycleRenders = 0;
    MTLasersItemRenderer tagItemRenderer;
    MTLasersItemRendererFluid tagFluidRenderer;
    ...
    public FilterTagScreen(FilterTagContainer container, Inventory inv, Component name) {
        ...
        tagItemRenderer = new MTLasersItemRenderer(minecraft.getTextureManager(), minecraft.getModelManager(), minecraft.getItemColors(), blockentitywithoutlevelrenderer);
        tagFluidRenderer = new MTLasersItemRendererFluid(minecraft.getTextureManager(), minecraft.getModelManager(), minecraft.getItemColors(), blockentitywithoutlevelrenderer, this);
    }
    ...
    public void init() {
        ...
        ResourceLocation add = new ResourceLocation(MTLasers.MODID, "textures/gui/buttons/add.png");
        ...
        ResourceLocation remove = new ResourceLocation(MTLasers.MODID, "textures/gui/buttons/remove.png");
        ...
        ResourceLocation clear = new ResourceLocation(MTLasers.MODID, "textures/gui/buttons/clear.png");
        Button clearButton = new IconButton(getGuiLeft() + 115, getGuiTop() + 5, 16, 16, clear, (button) -> {
            tags.clear();
        });
        leftWidgets.add(clearButton);

        ResourceLocation pageup = new ResourceLocation(MTLasers.MODID, "textures/gui/buttons/pageup.png");
        Button pageUp = new IconButton(getGuiLeft() + 100, getGuiTop() + 157, 12, 12, pageup, (button) -> {
            if (page < maxPages) page++;
        });
        leftWidgets.add(pageUp);

        ResourceLocation pagedown = new ResourceLocation(MTLasers.MODID, "textures/gui/buttons/pagedown.png");
    ...
    protected void renderLabels(PoseStack stack, int mouseX, int mouseY) {
        //font.draw(stack, Component.translatable("screen.mtlasers.allowlist").getString(), 5, 5, Color.DARK_GRAY.getRGB());
        //font.draw(stack, Component.translatable("screen.mtlasers.comparenbt").getString(), 7, 35, Color.DARK_GRAY.getRGB());
