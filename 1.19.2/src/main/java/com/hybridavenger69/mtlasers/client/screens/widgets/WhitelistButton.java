package com.hybridavenger69.mtlasers.client.screens.widgets;
...
public class WhitelistButton extends Button {
    ...
    private ResourceLocation allow = new ResourceLocation(MTLasers.MODID, "textures/gui/buttons/allowlisttrue.png");
    private ResourceLocation block = new ResourceLocation(MTLasers.MODID, "textures/gui/buttons/allowlistfalse.png");
