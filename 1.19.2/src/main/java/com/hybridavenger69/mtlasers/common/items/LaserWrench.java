package com.hybridavenger69.mtlasers.common.items;
...
import com.hybridavenger69.mtlasers.util.VectorHelper;
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (player.isShiftKeyDown()) {
            ...
            if (!targetPos.closerThan(sourcePos, maxDistance)) {
                player.displayClientMessage(Component.translatable("message.mtlasers.wrenchrange", maxDistance), true);
                return InteractionResultHolder.pass(wrench);
            }
