package com.hybridavenger69.mtlasers.common.items.filters;
...
public class BaseFilter extends Item {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level world, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (!sneakPressed) {
            ...
            MutableComponent toWrite = tooltipMaker("mtlasers.tooltip.item.filter.type", ChatFormatting.GRAY.getColor());
            boolean allowMode = getAllowList(stack);
            String allowString = allowMode ? "mtlasers.tooltip.item.filter.type.allow" : "mtlasers.tooltip.item.filter.type.deny";
            ...
            if (!(stack.getItem() instanceof FilterTag)) {
                toWrite = tooltipMaker("mtlasers.tooltip.item.filter.nbt", ChatFormatting.GRAY.getColor());
                boolean nbtMode = getCompareNBT(stack);
                String nbtString = nbtMode ? "mtlasers.tooltip.item.filter.nbt.allow" : "mtlasers.tooltip.item.filter.nbt.deny";
