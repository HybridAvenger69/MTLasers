...
public class MTLasersItemModels extends ItemModelProvider {
    public MTLasersItemModels(DataGenerator generator, ExistingFileHelper existingFileHelper) {
        super(generator, MTLasers.MODID, existingFileHelper);
    }
