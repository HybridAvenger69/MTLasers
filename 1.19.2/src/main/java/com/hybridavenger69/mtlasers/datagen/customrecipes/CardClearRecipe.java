package com.hybridavenger69.mtlasers.datagen.customrecipes;
...
public class CardClearRecipe extends ShapelessRecipe {
    ...
    //@ObjectHolder("mtlasers:cardclear")
    //public static CardClearRecipe.Serializer SERIALIZER;

    public static class Serializer extends ShapelessRecipe.Serializer {
        private static final ResourceLocation NAME = new ResourceLocation("mtlasers", "cardclear");
